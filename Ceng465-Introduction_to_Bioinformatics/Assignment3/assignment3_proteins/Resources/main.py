...
if __name__ == "__main__":
  ...
  solution.parseFile("4uap.pdb") # id's are given as "id-2" in the file.
  solution.createPairs()
  solution.makeGroup()
  solution.printGroups() """

  files = ['2bti.pdb','3r0a.pdb','4uap.pdb','6k62.pdb','6k97.pdb','6lac.pdb',]
  for file in files:
    print(file)
    solution = Assignment3()
    solution.parseFile(file) # id's are given as "id-2" in the file.
    solution.createPairs()
    solution.makeGroup()
    solution.printGroups()