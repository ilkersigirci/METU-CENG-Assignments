...
public:
	...
	Coordinate getClosestCoord(Player* player, std::vector<int> distances, std::vector<Player*> myPlayers);
	Coordinate whereToMove(std::vector<Coordinate> validMove,Coordinate c);
};
