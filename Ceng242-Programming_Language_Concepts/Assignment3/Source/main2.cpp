...
void carTests() {
    ...
    car4.Lap(average);
    car4.Lap(average);
    printResult(car4.getNumberOfLaps() == 3); 

    TESTHEADER("INDEXING TESTS");
    TESTNAME("EXISTING");
    printResult(car4[0].getLaptime() == (*car4.getHead()).getLaptime());
    printResult(car4[1].getLaptime() == (*(car4.getHead()->getNext())).getLaptime());
    TESTNAME("NONEXISTING");
    printResult(car4[5].getLaptime() == Laptime(0).getLaptime());


    TESTHEADER("COPY CONSTRUCTOR TESTS");
    Car car4_cp = Car(car4);
    printResult(car4.getDriverName() == car4_cp.getDriverName() &&
                car4.getHead()->getLaptime() == car4_cp.getHead()->getLaptime() &&
                car4.getHead()->getNext()->getLaptime() == car4_cp.getHead()->getNext()->getLaptime() &&
                car4.getHead()->getNext()->getNext()->getLaptime() ==
                car4_cp.getHead()->getNext()->getNext()->getLaptime()
    );
...
void raceTests() {
    ...
    out1 << r3;
    ++r3;
    r3.goBacktoLap(r3.getHead()->getNumberOfLaps() - 2);
    out2 << r3;
