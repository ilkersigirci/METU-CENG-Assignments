...
public:
    ...
    static int randomCarNum;
    std::string name[500] = {};
    int score[500] = {};
    void setRaceName(std::string name);
    Car * getHead() const;
    void setHead(Car* newHead);
    Car * getTail() const;
    void setTail(Car* newTail);
    Laptime getAverageLaptime() const;
    void setAverageLaptime();
    void setAverageLaptime(int laptime);
    void clearCarLL();
    void pushBackCar(Car& car, int clearLaptime);
    void popBackCar();
    void orderCars();
    void swap(int index1, int index2);
    void setScore();
    int getFastestIndex() const;
    int padding(int num) const;
    int getDriverIndex(std::string driverName) const;
